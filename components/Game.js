...
export default function Results({ results }) {
  ...
  return (
    <div className="flex justify-center items-center p-10">
      ...
      {isStart === false && (
        <div id="border" className="bg-red-500 border-2 border-black px-5 pb-5">
      ...
      {isStart === true && (
        <div
          id="border"
          className="relative bg-slate-100 border-2 border-black px-5 pb-5"
        >
          <div className="flex justify-between p-5">
            <div id="controlers" className="flex">
              <h2 className="flex text-black text-2xl mr-10">
                Nom du pays :
